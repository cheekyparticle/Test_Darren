...
def plot_ipol(mdm=SIGNALS[SIGNALS.keys()[0]].limits["mdm"][0],
              ...
              c5=SIGNALS[SIGNALS.keys()[0]].limits["c5"][0],
              c8=SIGNALS[SIGNALS.keys()[0]].limits["c8"][0],
              c11=SIGNALS[SIGNALS.keys()[0]].limits["c11"][0]):
    import numpy as np
    import matplotlib.pyplot as plt
    PP = {"mdm":mdm, "c1":c1, "c5":c5, "c8":c8, "c11":c11}
